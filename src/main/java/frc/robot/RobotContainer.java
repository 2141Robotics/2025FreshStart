...
public class RobotContainer {
  ...
  private final CommandXboxController operatorController = new CommandXboxController(Constants.OPERATOR_PORT);

  public final LEDs leds = new LEDs(drivetrain.getQuailSwerveDrive());
