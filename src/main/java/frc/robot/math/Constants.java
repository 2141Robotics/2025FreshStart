...
public class Constants {
    ...
    // Wtf does this do? It's somehow tied to odometry
    public static final double KALMAN_FILTER_W = 0.008;

    // Time between each loop, currently 20 ms
    ...
    public static final LEDPattern PATTERN_DLS_GREEN = LEDPattern.solid(new Color(15 / 255.0, 77 / 255.0, 42 / 255.0))
