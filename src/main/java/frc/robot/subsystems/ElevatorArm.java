...
public class ElevatorArm extends SubsystemBase {
  ...
  public void init() {
    ...
    SoftwareLimitSwitchConfigs elevatorMotorSoftwareLimitSwitchConfig =
    ...
    SoftwareLimitSwitchConfigs armMotorSoftwareLimitSwitchConfig =
        new SoftwareLimitSwitchConfigs()
            .withForwardSoftLimitEnable(true)
  ...
  public Command WaitForArmAbove(double angle) {
    return this.run(() -> {})
        .until(
            () -> {
              return this.armMotor.getPosition().getValueAsDouble()
                  >= angle - Constants.ARM_TOLERANCE;
            });
  }
  ...
  public Command WaitForElevatorAbove(double angle) {
    return this.run(() -> {})
        .until(
            () -> {
              return this.leftMotor.getPosition().getValueAsDouble()
                  >= angle - Constants.ELEVATOR_TOLERANCE;
            });
  }
