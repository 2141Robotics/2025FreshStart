...
public class LEDSubsystem extends SubsystemBase {
    ...
    LEDPattern m_up = LEDPattern.gradient(GradientType.kDiscontinuous, Color.kPurple, Color.kDarkBlue);
    LEDPattern m_down = LEDPattern.gradient(GradientType.kDiscontinuous, Color.kDarkBlue, Color.kPurple);
    ...
    public void runPattern(LEDPattern pattern) {
        ...
        if(blinking){
            pattern = pattern.blink(Time.ofBaseUnits(Constants.blinkOnLength, Seconds), Time.ofBaseUnits(Constants.blinkOffLength, Seconds));
            cyclesWhileBlinking++;
