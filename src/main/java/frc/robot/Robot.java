...
public class Robot extends TimedRobot {
  ...
  // For data logging of controller inputs
  // PLEASE DON'T DELETE ME UNLESS YOU DON'T WANT
  // TO LOG CONTROLLER INPUTS
  // ALSO DON'T USE ME FOR ANYTHING ELSE
  @SuppressWarnings("unused")
  private final XboxController driverControllerLog = new XboxController(Constants.DRIVER_PORT);
  @SuppressWarnings("unused")
  private final XboxController operatorControllerLog = new XboxController(Constants.OPERATOR_PORT);
  ...
  public void testInit() {
    m_robotContainer.drivetrain.getQuailSwerveDrive().orchestra.play();
